  ...
  (e.fn.attr2 = function () {
    ...
    (e.fn.ajaxSubmit = function (t, r, n, s) {
      ...
      function c(r) {
        ...
        function i() {
          ...
          var r = p.attr2("target"),
            i = p.attr2("action"),
            o =
              p.attr("enctype") || p.attr("encoding") || "multipart/form-data";
        ...
        function s(t) {
          if (!x.aborted && !X) {
            if (
              ((O = n(v)) || (a("cannot access response document"), (t = L)),
              t === A && x)
            )
                ...
                if (l || f.textarea) {
                  ...
                  if (p)
                    (x.responseText = p.value),
                      ...
                      (x.statusText =
                        p.getAttribute("statusText") || x.statusText);
                  else if (l) {
                ...
                x.status &&
                  (i =
                    (x.status >= 200 && x.status < 300) || 304 === x.status
                      ...
                      : "error"),
                "success" === i
                  ? (f.success && f.success.call(f.context, M, "success", x),
                    S.resolve(x.responseText, "success", x),
                    d && e.event.trigger("ajaxSuccess", [x, f]))
                  : i &&
        ...
        E && F && ((f.extraData = f.extraData || {}), (f.extraData[E] = F)),
      ...
      if (
        ...
        t.success &&
          (e.isArray(t.success) ? e.merge(T, t.success) : T.push(t.success));
      if (
    ...
    (e.fn.formToArray = function (t, r, a) {
      ...
      var o,
        ...
        u = this.attr("id"),
        c =
          t || void 0 === s.elements ? s.getElementsByTagName("*") : s.elements;
      if (
        (c && (c = e.makeArray(c)),
        u &&
      ...
      for (l = 0, h = c.length; l < h; l++)
        if (((m = c[l]), (d = m.name) && !m.disabled))
          if (t && s.clk && "image" === m.type)
            s.clk === m &&
              (n.push({ name: d, value: e(m).val(), type: m.type }),
              n.push(
